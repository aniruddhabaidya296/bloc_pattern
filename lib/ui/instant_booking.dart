...
class _InstantBookingState extends State<InstantBooking> {
  InstantBookingBloc instantBookingBloc;
  @override
  void initState() {
    super.initState();
    instantBookingBloc = BlocProvider.of<InstantBookingBloc>(context);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocListener(
        bloc: instantBookingBloc,
        listener: (context, state) {
          if (state is InstantBookingFailed) {
            return Center(
              child: Container(
          ...
          } else if (state is InstantBookingLoading) {
            return Container(
          ...
          } else if (state is InstantBookingSuccess) {
            return Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Stack(
